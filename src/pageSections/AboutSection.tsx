            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-12 max-w-[540px] lg:mb-0">
                <h2 className="mb-5 text-3xl font-bold leading-tight text-dark dark:text-white sm:text-[40px] sm:leading-[1.2]">
                  Discover DebtsCleared: Pioneers in Debt Relief Innovation
                </h2>
                <p className="mb-10 text-base leading-relaxed text-body-color dark:text-dark-6">
                  DebtsCleared is at the forefront of debt relief innovation,
                  dedicated to simplifying the debt application process through
                  cutting-edge technology and user-centred design.
                  <br />
                </p>
