      ...
      <div className="relative p-4 flex items-center justify-between">
        <div className="hover:cursor-pointer">
          <a onClick={() => navigator("/")} className="block text-center header-logo" style={{padding: 0, margin: 0}}>
           <img src={logo} className="" width="100" alt=""/>
          </a>
        </div>
            ...
            >
              <ul className="blcok lg:flex 2xl:ml-20">
                ...
                <li className="group relative" id="isLoged">
                  <a
                    onClick={() => navigator('/fill-application')}
                    className={`cursor-pointer ud-menu-scroll mx-8 flex py-2 text-base font-medium  group-hover:text-primary dark:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:group-hover:opacity-70 ${location.pathname !== '/'? 'text-body-color ':'lg:text-white lg:group-hover:text-white'}`}
                  >
                    Fill Application
                  </a>
          ...
          <div className="flex items-center justify-end pr-16 lg:pr-0">
            ...
            <div className="hidden sm:flex">
              ...
              <span
                ...
                className="cursor-pointer signUpBtn rounded-md bg-white bg-opacity-20 px-6 py-2 text-base font-medium text-blue-950 duration-300 ease-in-out hover:bg-opacity-100 hover:text-dark"
              >
                Sign Up
              </span>
            </div>
